...
<html class="no-js" lang="">
    ...
    <body class="about">
        ...
        <section class="hero-title" style="background-image:url(../resources/img/detailviewhead.jpg);">		
            <div class="container">			
                <div class="row">					
                    <h2>CICAGO MOONS</h2>
                </div><!-- // .row -->
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="imgbox style4">
                            <div class="img">
                                <img src="../resources/img/detailviewchef.jpg" alt="About the image">
                            </div>

                            <div class="align">
                                <h3>Chef</h3>
                                <p>젊은 DJ의 감각으로 스테이크 고유의 맛을 연구했습니다. 미국의 요리법과 한국만의 재료를 이용한 한국인에 맞는 맛을 여러분께 선보입니다.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="imgbox style4">
                            <div class="img">
                                <img src="../resources/img/detailviewtruck.jpg" alt="About the image">
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="imgbox style4">
                            <div class="img">
                                <img src="../resources/img/detailviewmenu.jpg" alt="1895X1000 About the image">
                            </div>

                            <div class="align">
                                <h3>Main Menu</h3>
                                <p>쉐프가 직접 고른 1++등급의 한우 살치살을 고열의 철판에 짧은 시간에 구워내어 육즙의 손실을 최소화시킨 고급스러운 맛</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- -----------------------  위의 foreach문 반복 끝--------------------------------------- -->                            
 <!-- -----------------------  위의 foreach문 완성시 삭제해야 할 부분 시작--------------------------------------- -->                            
                            ...
                            <div>
                                <div class="testimonial">
                                    <p>가격이 비싸서 하나로 둘이 먹었는데 결국은 하나 더 주문했네요. 먹고 나면 가격이 절대 비싸다는 생각이 안듭니다.</p>
 ...
 <!-- -----------------------  위의 foreach문 완성시 삭제해야 할 부분 끝--------------------------------------- -->                            
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<ul class="timeline">
				<!-- timeline time label -->
					<span><input class="btn btn-primary" id="repliesBtn" value="더 많이 보기"></span>
				</ul>
			</div>
		</div>
        <!-- // SECTION 5 -->
...
<!-- ----------------------- foreach문으로 반복-------------------------------------- -->                 
                    <div class="col-md-6">
                        <div class="imgbox style4">
                            <div class="img">
                                <img src="../resources/img/detailviewgallery1.jpg" alt="1895x1000 About the image">
                            </div>
...
<!-- -----------------------  위의 foreach문 완성시 삭제해야 할 부분 시작--------------------------------------- -->                     
                    ...
                    <div class="col-md-6">
                        <div class="imgbox style4">
                            <div class="img">
                                <img src="../resources/img/detailviewgallery2.jpg" alt="About the image">
                            </div>
